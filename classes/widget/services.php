...
class services extends WP_Widget {
	 ...
	 * @var string
	 */
	protected $widget_slug = 'services-slug';
	 ...
	 * @var string
	 */
	protected static $shortcode = 'cmb2_widget_services';
	...
	public function __construct() {
		...
		parent::__construct(
			$this->widget_slug,
			esc_html__( 'Services: Top', 'cold-storage' ),
			array(
				'classname' => $this->widget_slug,
				'customize_selective_refresh' => true,
				'description' => esc_html__( 'Widget for page services', 'cold-storage' ),
			)
		);

		$this->cmb2_fields = array(
			array(
				'name'   => __( 'Title', 'cold-storage' ),
				'id_key' => 'title',
				'id'     => 'title',
				'type'   => 'text',
			),
			array(
				'name'   => __( 'Description', 'cold-storage' ),
				'id'     => 'description',
				'id_key' => 'description',
				'type'   => 'textarea_small',
			),
			array(
				'name' => __( 'Link to the Image', 'cmb2' ),
				'id_key' => 'image_link',
				'id'     => 'image_link',
				'type'   => 'text_url',
			),
	...
	public function widget( $args, $instance ) {
		echo self::get_widget( array_merge( $args, $instance, [$this->id] )  );
	}
	...
	public static function get_widget( $atts ) {
		$templates = 'widget/form/services.twig';
		\Timber::render( $templates, $atts);
	}
 ...
 */
function register_wds_services() {
	register_widget( 'services' );
}
add_action( 'widgets_init', 'register_wds_services' );
