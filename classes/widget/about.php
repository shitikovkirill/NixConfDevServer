 ...
 */
class CMB2_about extends WP_Widget {
	 ...
	 * @var string
	 */
	protected $widget_slug = 'about-slug';
	 ...
	 * @var string
	 */
	protected static $shortcode = 'cmb2_widget_about';
	...
	public function __construct() {
		...
		parent::__construct(
			$this->widget_slug,
			esc_html__( 'About: Right sidebar', 'your-textdomain' ),
			array(
	...
	public static function get_widget( $atts ) {
		...
		$templates = 'widget/form/about.twig';
 ...
 */
function register_wds_about() {
	register_widget( 'CMB2_about' );
}
add_action( 'widgets_init', 'register_wds_about' );
